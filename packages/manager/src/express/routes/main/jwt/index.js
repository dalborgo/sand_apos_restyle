...
function getQueryGcFields () {
  return 'customize_stelle_options.update_from_app hotelEnabled, enable_fattura_elettronica_send eInvoiceSendEnabled, day_trim_hour dayTrimHour '// lascia ultimo spazio
}
